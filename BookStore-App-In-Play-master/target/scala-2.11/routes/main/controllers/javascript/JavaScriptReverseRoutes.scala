...
package controllers.javascript {
  ...
  class ReverseBooksController(_prefix: => String) {
    ...
    def edit: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(id0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "books/edit/" + (""" + implicitly[PathBindable[Integer]].javascriptUnbind + """)("id", id0)})
        }
      """
    )
    ...
    def show: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(id0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "books/" + (""" + implicitly[PathBindable[Integer]].javascriptUnbind + """)("id", id0)})
        }
      """
    )
    ...
    def destroy: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(id0) {
          return _wA({method:"DELETE", url:"""" + _prefix + { _defaultPrefix } + """" + "books/delete/" + (""" + implicitly[PathBindable[Integer]].javascriptUnbind + """)("id", id0)})
        }
      """
    )
